...
int			main(void)
{
	...
	SuperTrap	Pelb = SuperTrap("Pelb");
	std::cout << std::endl;
	for (int i = 0; i < 5; i++)
	{
		Pelb.vaulthunter_dot_exe("Vincent");
		std::cout << std::endl;
	}
	Pelb.ninjaShoebox(Blap);
	std::cout << std::endl;
	Pelb.ninjaShoebox(Pilb);
	std::cout << std::endl;
	Pelb.ninjaShoebox(Blop);
	std::cout << std::endl;
	Pelb.takeDamage(50);
	std::cout << std::endl;
	Pelb.beRepaired(25);
	std::cout << std::endl;
	Pelb.takeDamage(1000);
	std::cout << std::endl;
	Pelb.beRepaired(1000);
	std::cout << std::endl;
	return (0);
}
